...
df_1 = pd.read_csv('/Users/noahmeyer/Desktop/Masters/Thesis/new folder real/OKHERE/Python/Game files 2.0/G1 Data')

df_2 = pd.read_csv('/Users/noahmeyer/Desktop/Masters/Thesis/new folder real/OKHERE/Python/Game files 2.0/G2 Data')

df_3 = pd.read_csv('/Users/noahmeyer/Desktop/Masters/Thesis/new folder real/OKHERE/Python/Game files 2.0/G3 Data')

df_4 = pd.read_csv('/Users/noahmeyer/Desktop/Masters/Thesis/new folder real/OKHERE/Python/Game files 2.0/G4 Data')

df_5 = pd.read_csv('/Users/noahmeyer/Desktop/Masters/Thesis/new folder real/OKHERE/Python/Game files 2.0/G5 Data')
...
ndf_1.to_csv('ndf_1.csv', index = False)

ndf_2.to_csv('ndf_2.csv', index = False)

ndf_3.to_csv('ndf_3.csv', index = False)

ndf_4.to_csv('ndf_4.csv', index = False)

ndf_5.to_csv('ndf_5.csv', index = False)
